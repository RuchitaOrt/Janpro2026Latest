...
GetComplaintResponse getComplaintResponseFromJson(String str) => GetComplaintResponse.fromJson(json.decode(str));

String getComplaintResponseToJson(GetComplaintResponse data) => json.encode(data.toJson());
...
class GetComplaintResponse {
    ...
    factory GetComplaintResponse.fromJson(Map<String, dynamic> json) => GetComplaintResponse(
        status: json["status"],
