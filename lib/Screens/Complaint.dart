...
class _ComplaintState extends State<Complaint> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    setState(() {
      ...
      datetatcontroller.text = DateFormat(
        'dd-MM-yyyy',
            ...
            child: TabBarView(
              ...
              children: [
                ...
                unitcomplainttab2detail(
                  mainlisttab[maintag].dependentdata,
                  "2",
                ),
  ...
  Widget _buildChoicemainListForTab() {
    final selectedItem = maintag < mainlisttab.length
        ? mainlisttab[maintag]
        : null;
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      return ListTile(
                                        ...
                                        onTap: () {
                                          ...
                                          final value = mainlisttab.indexOf(
                                            item,
                                          );
                                          setState(() {
                                            _isSelected = item.clientName;
  ...
  /*complaintdetail(List<supercomp.DependentdatumElement> _elements, String tab) {
    ...
    issuperExpandedList = List<bool>.generate(_elements.length, (index) => false);
...
//
                              ...
                              (role == GlobalLists.headrole ||
                                  ...
                                  tab == "1"
                                      ?
                                      //18apirl
                                      //   _elements[element].status=="Escalated"?Container(height: 5,):
                                      Column(
                                          mainAxisAlignment:
                                              MainAxisAlignment.start,
                                          crossAxisAlignment:
...
//                                             :Container()
  ...
  complaintdetail(List<supercomp.DependentdatumElement> _elements, String tab) {
    ...
    for (var element in _elements) {
      ...
      String dateKey = element.loggedAt
          .split('(')[1]
          .replaceAll(')', '')
          .trim();
    ...
    issuperExpandedList = List<bool>.generate(
      _elements.length,
      (index) => false,
    );
    return _elements.length > 0
  ...
  complaintdetailtab2(
    List<supercomp.DependentdatumElement> _elements,
    String tab,
  ) {
    issuperExpandedListdependent = List<bool>.generate(
      _elements.length,
      (index) => false,
    );
                                                          ...
                                                          Text(
                                                            ...
                                                            overflow:
                                                                TextOverflow
                                                                    .ellipsis,
                                                            maxLines:
                                                                issuperExpandedListdependent[element]
                                                                ? null
                                                                : 3,
                                                          ),
                                                        ],
  ...
  /*complaintdetailtab2(List<supercomp.DependentdatumElement> _elements, String tab) {
    // Sort by date ascending
    _elements.sort((a, b) => a.loggedAt.compareTo(b.loggedAt));

    // Group by loggedAt date (from parentheses format)
    Map<String, List<supercomp.DependentdatumElement>> grouped = {};
    for (var e in _elements) {
      String dateKey = e.loggedAt.split('(')[1].replaceAll(')', '').trim();
    ...
    issuperExpandedListdependent = List<bool>.generate(_elements.length, (index) => false);
    _supervisortab2controller = ItemScrollController();
    ...
    return _elements.isNotEmpty
      ...
      child: ScrollablePositionedList.builder(
        ...
        itemBuilder: (context, dateIndex) {
          String date = sortedDates[dateIndex];
          List<supercomp.DependentdatumElement> dateElements = grouped[date]!;
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            GestureDetector(
                                              onTap: () {
                                                if (element.image1 != "" && element.image1 != null) {
                                                  showimage("Complaints", element.image1, element.image2);
                                                }
                                              },
                                              child: Image.network(
                                                "${element.image1}",
                                            ...
                                            Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  SizedBox(height: 5),
                                                  element.complainantName == "Cleaning"
                                                      ? Text(
                                                    "${element.masterAreaName}-${element.masterBlockName}",
                                                    style: AppFonts.headerStyle(
                            ...
                            Container(
                              ...
                              child: Card(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    "${element.comment}",
                                    maxLines: issuperExpandedListdependent[index] ? null : 3,
                                    overflow: TextOverflow.ellipsis,
                                    style: AppFonts.headerStyle(
                                      fontSize: ResponsiveFlutter.of(context).fontSize(1.4),
                                      color: customcolor.black,
...
*/
  ...
  complaintdetailtab3(
    ...
    issuperExpandedListresolved = List<bool>.generate(
      _elements.length,
      (index) => false,
    );
    //  print("initialindexvalue");
                                                          ...
                                                          Text(
                                                            ...
                                                            overflow:
                                                                TextOverflow
                                                                    .ellipsis,
                                                            maxLines:
                                                                issuperExpandedListresolved[element]
                                                                ? null
                                                                : 3,
                                                          ),
                                                        ],
  ...
  /*complaintdetailtab3(List<supercomp.DependentdatumElement> _elements, String tab) {
    // Sort by date ascending
    _elements.sort((a, b) => a.loggedAt.compareTo(b.loggedAt));

    // Group by loggedAt date
    Map<String, List<supercomp.DependentdatumElement>> grouped = {};
    for (var e in _elements) {
      String dateKey = e.loggedAt.split('(')[1].replaceAll(')', '').trim();
      if (!grouped.containsKey(dateKey)) {
    ...
    issuperExpandedListresolved = List<bool>.generate(_elements.length, (index) => false);
    _supervisortab3controller = ItemScrollController();
    ...
    return _elements.isNotEmpty
      ...
      child: ScrollablePositionedList.builder(
        ...
        itemBuilder: (context, dateIndex) {
          String date = sortedDates[dateIndex];
          List<supercomp.DependentdatumElement> items = grouped[date]!;
                            ...
                            Container(
                              ...
                              child: Card(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    "${element.comment}",
                                    maxLines: issuperExpandedListresolved[index] ? null : 3,
                                    overflow: TextOverflow.ellipsis,
                                    style: AppFonts.headerStyle(
                                      fontSize: ResponsiveFlutter.of(context).fontSize(1.4),
                                      color: customcolor.black,
...
//
  ...
  unitcomplaintdetail(
    List<unitcom.DependentdatumElement> _elements,
    String tab,
  ) {
  ...
  unitcomplainttab2detail(
    ...
    isExpandedListdependent = List<bool>.generate(
      _elements.length,
      (index) => false,
    );
    return _elements.length > 0
                                                      ...
                                                      children: [
                                                        Text(
                                                          ...
                                                          overflow: TextOverflow
                                                              .ellipsis,
                                                          maxLines:
                                                              isExpandedListdependent[element]
                                                              ? null
                                                              : 3,
                                                        ),
                                                        SizedBox(height: 2),
  ...
  //                         ),
  //                       ),
  //                       if (img['label'] != null && img['label']!.isNotEmpty)
  //                         Positioned(
  //                           top: 10,
  //                           left: 10,
  //                           child: Container(
  ...
  //                   // Limit height so it doesn’t overflow the screen
  ...
  //                               width: screenWidth,
  //                               height: displayHeight,
  //                               fit: BoxFit.contain, // maintains ratio
  //                               errorBuilder: (context, error, stackTrace) =>
  //                                   const Icon(Icons.broken_image, size: 100),
  //                             ),
  //                           ),
  ...
  // /// Helper to get actual image size before rendering
  // Future<Size> _getImageSize(String url) async {
  //   final completer = Completer<Size>();
  //   final image = Image.network(url);
  ...
  /// Common full-screen image viewer
  ///
  // void _showFullImageDialog(BuildContext context, String imageUrl, String label) {
  //   showDialog(
  //     context: context,
  ...
  unitcomplainttab3detail(
    ...
    isExpandedListresolved = List<bool>.generate(
      _elements.length,
      (index) => false,
    );
    return _elements.length > 0
                                            ...
                                            onTap: () {
                                              ...
                                              if (item.image1 != "" ||
                                                ...
                                                showImagePopup(context, [
                                                  ...
                                                  if (item.closeImg1 != null &&
                                                      item.closeImg1.isNotEmpty)
                                                    {
                                                      'url': item.closeImg1,
                                                      'label': 'Resolved',
                                                    },
                                                  if (item.closeImg2 != null &&
                                                      item.closeImg2.isNotEmpty)
                                                    {
                                                      'url': item.closeImg2,
                                                      'label': 'Resolved',
                                                    },
                                                      ...
                                                      children: [
                                                        Text(
                                                          ...
                                                          overflow: TextOverflow
                                                              .ellipsis,
                                                          maxLines:
                                                              isExpandedListresolved[element]
                                                              ? null
                                                              : 3,
                                                        ),
                                                        SizedBox(height: 2),
                        ...
                        onTap: () {
                          ...
                          if (duration != "") {
                            if (comingfrom == "add") {
                              ...
                              } else if (datetatcontroller.text.contains(
                                todaydate,
                              )) {
                                if (selectedtime.isAfter(DateTime.now())) {
                                  setState(() {
  ...
  addcomplaint(BuildContext context) {
    //add Complaints
    showModalBottomSheet(
      backgroundColor: Colors.white,
      isScrollControlled: true,
                  ...
                  GestureDetector(
                    onTap: () {
                      setStateDialgoue(() {
                        ...
                        //20feb
                        siteidconfig = GlobalLists.complaintclientlist[index].id
                            .toString();
                      });
                    },
                    child: Padding(
                  ...
                  GestureDetector(
                    onTap: () {
                      setStateDialgoue(() {
                        ...
                        blockid = GlobalLists.masterblocklist[index].blockObj
                            .toString();
                        isexpandedmasterblock = false;
                      });
                    },
                    ...
                    GestureDetector(
                      onTap: () {
                        setStateDialgoue(() {
                          ...
                          complainttype = GlobalLists.clientticketlist[index].id
                              .toString();
                          isexpandedcomplaint = false;
                          masterareacontroller.text = "";
                          masterblockcontroller.text = "";
            ...
            setState(() {
              ...
              if (widget.isnotify) {
                if (widget.status == "Pending") {
                  ...
                  for (
                    int i = 0;
                    i < GlobalLists.dependentcomlist.length;
                    i++
                  ) {
  ...
  getunitcomplaintApi() async {
    ...
    if (status1) {
      ...
      APIManager().apiRequest(
        ...
        (error) {
          log('unitcomplaint ERR msg is $error');
  ...
  getoperationdependentApi(String id) async {
    ...
    final payload = {'id': id, 'supervisor': supervisorid};
    ...
    if (status) {
      ...
      await DBHelper.insertOfflineRequest(
        '${Global.baseUrl}/api/ticketmanagement/DependentComplaint',
        payload,
      );
                      ...
                      children: [
                        ElevatedButton(
                          onPressed: () {
                            if (result.isNotEmpty) {
                              Navigator.pop(context);
                              File? image1 = result.length > 0
                                  ? File(result[0])
                                  : null;
                              File? image2 = result.length > 1
                                  ? File(result[1])
                                  : null;
  ...
  Future getoperationalresolvedApi(
    String id, {
    File? image1,
    File? image2,
  }) async {
    ...
    if (status) {
      ...
      if (image1 != null) {
        request.files.add(
          await http.MultipartFile.fromPath('close_img1', image1.path),
        );
      }
      if (image2 != null) {
        request.files.add(
          await http.MultipartFile.fromPath('close_img2', image2.path),
        );
      }
  ...
  operationalupdatetatApi(String id, String duration) async {
    ...
    if (isConnected) {
      ...
      await DBHelper.insertOfflineRequest(
        '${Global.baseUrl}/api/ticketmanagement/Update_TAT',
        payload,
      );
      // Navigator.pop(context);
      setState(() {
