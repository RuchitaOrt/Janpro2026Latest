                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Center(child: GestureDetector(
                          ...
                          child: Text('OT Mark',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),))),
                      ),
                    ),
                    SizedBox(width: 20,),
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(15.0),
                        child: Center(child: Text('change Status',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),)),
                      ),
                    ),
                  ],),
                ],
